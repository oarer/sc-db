			...
			await mergeFolderGroupsToListing(OUT_DIR, {
				groups: {
					...
					attachments: [
						...
						"items/attachment/collimator_sights",
						"items/attachment/forend",
						"items/attachment/mag",
					...
					plates: [
						...
						"items/other/zj9m.json",
						"items/other/514q.json",
						"items/other/j3rg.json",
						"items/other/l3mo.json",
						"items/other/rg5y.json",
						"items/other/0ngy.json",
						"items/other/m3o2.json",
						"items/other/o31m.json",
						"items/other/2v55.json",
						"items/other/3dy5.json",
						"items/other/7zqj.json",
						"items/other/6gk0.json",
						"items/other/9yly.json",
						"items/other/1pz2.json",
						"items/other/g3q5.json",
						"items/other/zjrm.json",
						"items/other/j3dg.json",
						"items/other/2vz5.json",
						"items/other/w4d3.json",
						"items/other/rg7y.json",
						"items/other/0nzy.json",
						"items/other/m372.json",
						"items/other/o37m.json",
						"items/other/n372.json",
						"items/other/7zjj.json",
